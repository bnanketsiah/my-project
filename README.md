...
" alt="Cute kitten with flowers" class="rounded-md h-[300px]" style="object-fit: cover;" />
  ...
  <script type="module">
    ...
    const imagePaths = [ 
      "./html_pics/image1.gif",
      "./html_pics/image2.gif",
      "./html_pics/image3.gif",
      "./html_pics/image4.gif",
      "./html_pics/image5.gif",
      "./html_pics/image6.gif",
    ];
    ...
    yesButton.addEventListener('click', () => {
      imageDisplay.src = './htmlpics/image7.gif'; // Change to image7.gif
